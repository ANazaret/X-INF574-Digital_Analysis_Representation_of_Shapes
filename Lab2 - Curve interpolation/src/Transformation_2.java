...
public class Transformation_2 {
    ...
    public Transformation_2(double theta, Point_2 center) {
        ...
        Transformation_2 translation1 = new Transformation_2(new Vector_2(center.toDouble()).opposite());
        Transformation_2 translation2 = new Transformation_2(new Vector_2(center.toDouble()));

        this.m = translation2.m.times(matrix).times(translation1.m);
